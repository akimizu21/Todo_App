            ...
            return (
              <li className={styles.todoContents} key={todo.id}>
                ...
                <div className={styles.farContainer}>
                  <FontAwesomeIcon icon={faCircleCheck} onClick={() => handleCheckTodo(todo.id, todo.title)} className={styles.far}/>
                  <FontAwesomeIcon icon={faCircleXmark} onClick={() => handleDeleteTodo(todo.id, todo.title)} className={styles.far}/>
                </div>
              </li>
            )
          })}
